...
export default function PasswordGenerator({ onSelect, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 z-[60]">
      <div
      ...
      >
        <div className="p-3 sm:p-6">
          ...
          <div className="flex items-center justify-between gap-2 mb-4 sm:mb-6">
            <h2 className="font-heading text-base sm:text-2xl text-lime uppercase tracking-wider truncate">[ Générateur ]</h2>
            <button
              onClick={onClose}
            ...
            <div className="space-y-4 mb-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer py-2 sm:py-0 min-h-[44px] sm:min-h-0">
                <input
                  ...
                  className="w-5 h-5 sm:w-4 sm:h-4 accent-lime rounded border-cyan/30"
                />
                <span className="text-sm text-grey font-mono">Exclure caractères ambigus (0, O, l, 1, I)</span>
              </label>
            </div>
          ) : (
            <div className="mb-6">
